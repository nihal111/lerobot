...
def train(cfg: TrainPipelineConfig, accelerator: "Accelerator | None" = None):
    ...
    for _ in range(step, cfg.steps):
        ...
        if cfg.save_checkpoint and is_saving_step:
            ...
            # the all-gather. accelerator.get_state_dict() handles the FSDP
            # context (FULL_STATE_DICT, rank0_only=True, offload_to_cpu=True).
            # Only rank 0 materializes the full dict; others discard it.
